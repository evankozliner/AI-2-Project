...
Results produced by linear regression model had RMSE of 8.729 on test dataset and 4.0739 on training dataset. We also ran tests on a linear regression model that took into account the fundamentals data. 
...
Results produced by above mentioned linear regression model using fundamentals data had RMSE of 8.23 on test dataset and 4.08 on training dataset. Overall, the fundamentals data did not have a significant effect on the accuracy of the linear regression baseline model. 
